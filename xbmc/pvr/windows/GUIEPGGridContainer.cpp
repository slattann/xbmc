...
: IGUIContainer(parentID, controlID, posX, posY, width, height),
  ...
  m_guiProgressIndicatorTexture(CGUITexture::GetTexture(posX, posY, width, height, progressIndicatorTexture)),
...
: IGUIContainer(other),
  ...
  m_guiProgressIndicatorTexture(CGUITexture::GetTexture(*other.m_guiProgressIndicatorTexture)),
