...
bool CTextureBundleXBT::LoadTexture(const std::string& Filename, CTexture** ppTexture,
...
int CTextureBundleXBT::LoadAnim(const std::string& Filename, CTexture*** ppTextures,
...
bool CTextureBundleXBT::ConvertFrameToTexture(const std::string& name, CXBTFFrame& frame, CTexture** ppTexture)
{
