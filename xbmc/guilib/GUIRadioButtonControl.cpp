...
CGUIRadioButtonControl::CGUIRadioButtonControl(int parentID, int controlID, float posX, float posY, float width, float height,
    ...
    , m_imgRadioOnFocus(CGUITexture::GetTexture(posX, posY, 16, 16, radioOnFocus))
    , m_imgRadioOnNoFocus(CGUITexture::GetTexture(posX, posY, 16, 16, radioOnNoFocus))
    , m_imgRadioOffFocus(CGUITexture::GetTexture(posX, posY, 16, 16, radioOffFocus))
    , m_imgRadioOffNoFocus(CGUITexture::GetTexture(posX, posY, 16, 16, radioOffNoFocus))
    , m_imgRadioOnDisabled(CGUITexture::GetTexture(posX, posY, 16, 16, radioOnDisabled))
    , m_imgRadioOffDisabled(CGUITexture::GetTexture(posX, posY, 16, 16, radioOffDisabled))
{
  m_radioPosX = 0;
  m_radioPosY = 0;
...
CGUIRadioButtonControl::CGUIRadioButtonControl(const CGUIRadioButtonControl& left)
  : CGUIButtonControl(left),
    m_imgRadioOnFocus(CGUITexture::GetTexture(*left.m_imgRadioOnFocus)),
    m_imgRadioOnNoFocus(CGUITexture::GetTexture(*left.m_imgRadioOnNoFocus)),
    m_imgRadioOffFocus(CGUITexture::GetTexture(*left.m_imgRadioOffFocus)),
    m_imgRadioOffNoFocus(CGUITexture::GetTexture(*left.m_imgRadioOffNoFocus)),
    m_imgRadioOnDisabled(CGUITexture::GetTexture(*left.m_imgRadioOnDisabled)),
    m_imgRadioOffDisabled(CGUITexture::GetTexture(*left.m_imgRadioOffDisabled))
{
  m_radioPosX = 0;
  m_radioPosY = 0;
  m_imgRadioOnFocus->SetAspectRatio(CAspectRatio::AR_KEEP);
