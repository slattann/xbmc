...
public:
  ...
  static bool DemuxerToStreamDetails(std::shared_ptr<CDVDInputStream> pInputStream, std::shared_ptr<CDVDDemux> pDemux, CStreamDetails &details, const std::string &path = "");
  ...
  */
  static bool DemuxerToStreamDetails(std::shared_ptr<CDVDInputStream> pInputStream, std::shared_ptr<CDVDDemux> pDemuxer, const std::vector<CStreamDetailSubtitle> &subs, CStreamDetails &details);
