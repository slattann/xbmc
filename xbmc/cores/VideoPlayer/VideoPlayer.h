...
public:
  ...
  void Update(CDVDInputStream* input, std::shared_ptr<CDVDDemux> demuxer);
  void Update(CDVDInputStream* input, std::shared_ptr<CDVDDemux> demuxer, std::string filename2);
